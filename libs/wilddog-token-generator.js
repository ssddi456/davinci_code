...
;(require.main === module) && (function(){
  ...
  var wilddogTokenInstance = new module.exports(config.wilddogSuperToken);
  console.log( wilddogTokenInstance.createToken({ uid : '123456' }) );
